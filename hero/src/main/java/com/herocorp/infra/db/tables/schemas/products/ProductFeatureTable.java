 ...
 */
public class ProductFeatureTable extends TableHelper {

    public static final String TABLE_NAME = "heroapp_product_feature";
    public static final String PATH = "heroapp_product_feature";
    ...
    public ProductFeatureTable() {
        ...
        registerRevision(new TableRevision() {
            ...
            /**
             * ProductFeatureTable Table Schema creation
             */
