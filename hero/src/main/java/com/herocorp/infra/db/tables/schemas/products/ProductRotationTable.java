...
public class ProductRotationTable extends TableHelper {

    public static final String TABLE_NAME = "heroapp_rotation_img_attachment";
    public static final String PATH = "heroapp_rotation_img_attachment";
