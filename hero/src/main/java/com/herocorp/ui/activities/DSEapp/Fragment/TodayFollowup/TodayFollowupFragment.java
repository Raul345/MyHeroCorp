                ...
                if (flag == 1) {
                    if (priority.equalsIgnoreCase("Hot"))
                        listhot.add(new Followup(first_name, last_name, cell_ph_no, age, gender, email_addr, state, district, tehsil, city, x_con_seq_no, x_model_interested,
                                expected_date_purchase, x_exchange_required, x_finance_required, exist_vehicle, followup_comments, enquiry_id, follow_date, enquiry_entry_date, dealer_bu_id, priority, two_wheeler_type, area, occupation, usage, sales_pitch_no, followup_status));
